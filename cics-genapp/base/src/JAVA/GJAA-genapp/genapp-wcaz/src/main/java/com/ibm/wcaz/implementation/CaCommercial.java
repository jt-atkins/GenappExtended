...
public class CaCommercial extends CaPolicyRequest {
    ...
    public CaCommercial(String caRequestId, int caReturnCode, long caCustomerNum, long caPolicyNum, CaPolicyCommon caPolicyCommon, String caBRejectReason, String caBAddress, String caBPostcode, String caBLatitude, String caBLongitude, String caBCustomer, String caBPropType, int caBFirePeril, int caBFirePremium, int caBCrimePeril, int caBCrimePremium, int caBFloodPeril, int caBFloodPremium, int caBWeatherPeril, int caBWeatherPremium, int caBStatus, String caBFiller) {
    ...
    public int hashCode() {
        return super.hashCode() ^
            Integer.rotateLeft(caBRejectReason.hashCode(), 5) ^
            Integer.rotateLeft(caBAddress.hashCode(), 6) ^
            Integer.rotateLeft(caBPostcode.hashCode(), 7) ^
            Integer.rotateLeft(caBLatitude.hashCode(), 8) ^
            Integer.rotateLeft(caBLongitude.hashCode(), 9) ^
            Integer.rotateLeft(caBCustomer.hashCode(), 10) ^
            Integer.rotateLeft(caBPropType.hashCode(), 11) ^
            Integer.rotateLeft(Integer.hashCode(caBFirePeril), 12) ^
            Integer.rotateLeft(Integer.hashCode(caBFirePremium), 13) ^
            Integer.rotateLeft(Integer.hashCode(caBCrimePeril), 14) ^
            Integer.rotateLeft(Integer.hashCode(caBCrimePremium), 15) ^
            Integer.rotateLeft(Integer.hashCode(caBFloodPeril), 16) ^
            Integer.rotateLeft(Integer.hashCode(caBFloodPremium), 17) ^
            Integer.rotateLeft(Integer.hashCode(caBWeatherPeril), 18) ^
            Integer.rotateLeft(Integer.hashCode(caBWeatherPremium), 19) ^
            Integer.rotateLeft(Integer.hashCode(caBStatus), 20) ^
