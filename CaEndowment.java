...
public class CaEndowment extends CaPolicyRequest {
    ...
    public CaEndowment(String caRequestId, int caReturnCode, long caCustomerNum, long caPolicyNum, CaPolicyCommon caPolicyCommon, char caEEquities, char caEWithProfits, char caEManagedFund, String caEFundName, int caETerm, int caESumAssured, String caELifeAssured, String caEPaddingData) {
    ...
    public int hashCode() {
        return super.hashCode() ^
            Integer.rotateLeft(Character.hashCode(caEEquities), 5) ^
            Integer.rotateLeft(Character.hashCode(caEWithProfits), 6) ^
